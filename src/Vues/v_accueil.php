...
?>
<?= $_SESSION['estComptable'] ? '' : '<div class="alert alert-warning" role="alert"><strong>Rappel : </strong>Vos frais sont à déclarer au plus tard le dernier jour du mois 
...
<div id="accueil">
    <h2>
        Gestion des frais<small> - <?= $_SESSION['estComptable'] ? 'Comptable' : 'Visiteur' ?> : 
