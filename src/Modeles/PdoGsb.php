...
class PdoGsb {
    ...
    public function getInfosVisiteur($login, $mdp): array|bool {
        ...
        $requetePrepare = $this->connexion->prepare(
                ...
                . 'visiteur.prenom AS prenom, login.metier AS metier, login.email AS email, login.id AS idemail '
                . 'FROM visiteur '
                . 'INNER JOIN login '
    ...
    public function getInfosComptable($login, $mdp) {
        ...
        $requetePrepare = $this->connexion->prepare(
                ...
                . 'comptable.prenom AS prenom, login.metier AS metier, login.email as email '
                . 'FROM comptable '
                . 'INNER JOIN login '
    ...
    public function getCodeVisiteur($id) {
        $requetePrepare = $this->connexion->prepare(
                'SELECT login.codea2f AS codea2f '
                . 'FROM login inner join visiteur on login.id = visiteur.idlogin '
